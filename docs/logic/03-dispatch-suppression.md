...
<table>
<tr><th align="left">왜 필요했나</th><td>큐는 "최소 한 번" 전달이라 같은 메시지가 두 번 올 수 있다. 수신거부·반송 주소로 보내면 평판이 떨어지고 법 위반이다.</td></tr>
<tr><th align="left">무엇을 썼나</th><td><b>조건부 UPDATE claim</b>(PENDING→SENDING 을 한 문장으로 선점) + claim 토큰, 발송 전 억제 목록 확인, 리스너 동시성 8, 수신거부 푸터와 원클릭 수신거부 헤더, SMTP 타임아웃.</td></tr>
<tr><th align="left">결과</th><td>처리량 <b>20.5 → 157.7 msg/s</b>(약 7.7배), 동시 소비자 12개에서 <b>이중발송 0</b>. 로컬 측정 — <a href="../RETRO-scaling.md">RETRO-scaling</a>.</td></tr>
<tr><td colspan="2">한 통은 먼저 선점한 워커만 보내고, 수신거부한 주소에는 절대 보내지 않는다.</td></tr>
</table>
