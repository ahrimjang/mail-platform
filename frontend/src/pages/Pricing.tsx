...
const FAQS: { q: string; a: React.ReactNode }[] = [
  ...
  {
    q: "요금제 기준이 되는 발송량이 뭔가요?",
    a: "한 달 동안 실제로 발송된 이메일 통수예요. 연락처 수가 아니라 발송량 기준이라, 구독자가 많아도 보내는 만큼만 계산됩니다. 사용량은 관리 페이지의 사용량 카드에서 실시간으로 확인할 수 있어요.",
  },
  {
      ...
      <main className="op-container op-fade" style={{ padding: "44px 24px 64px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          <h2 style={{ fontSize: 30, fontWeight: 800, letterSpacing: "-0.02em", margin: 0 }}>
            성장 단계에 맞는 요금제를 선택하세요
          </h2>
          <p style={{ color: "var(--op-muted)", marginTop: 10, fontSize: 15, lineHeight: 1.7 }}>
            무료로 시작하고, 발송량이 늘어나면 그때 업그레이드하세요.<br />
            요금은 월 발송량 기준 — 한도에 닿아도 보내던 캠페인은 끝까지 나갑니다.
          </p>
